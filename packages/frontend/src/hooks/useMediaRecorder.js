...
function useMediaRecorder({
  ...
  const [errorCache, cacheError] = React.useState(null);
  const [mediaBlobCache, cacheMediaBlob] = React.useState(null);
  const [isAudioMutedCache, cacheIsAudioMuted] = React.useState(false);
