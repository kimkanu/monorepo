...
const Title: React.FC<Styled<Props>> = ({
  ...
  size === 'title'
    ...
    : size === 'sect'
      ? <h2 style={style} className={mergeClassNames('text-sect font-bold', className)}>{children}</h2>
      : <h3 style={style} className={mergeClassNames('text-sub font-bold', className)}>{children}</h3>
);
